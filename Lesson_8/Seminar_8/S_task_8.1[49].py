...
# phonebook = {'Иванов Иван': ['897097','работник'], 'Петров Петр': ['35346', 'не раб']}
# phonebook = [{'Иванов Иван': ['897097','работник']}, {'Петров Петр': ['35346', 'не раб']}]
# phonebook = [{1: ["Иванов", "Иван","89234145", "работник"]}]
# phonebook = [{'surname': "Иванов", 'name': "Иван", 'number': "89234145", 'discrip': "работник"}]
phonebook = {1: {'surname': "Иванов", 'name': "Иван", 'number': "89234145", 'discrip': "работник"}}
